''' time profiling of iso adjustment code '''
...
argn.add_argument('-n', type=int, default=50)      # number of images to collect
...
with open('fetch_latency.txt', 'w') as f:
    for it in fdiffs:
        f.write(str(it))
        f.write('\n')
        
with open('save_latency.txt', 'w') as f:
    for it in sdiffs:
        f.write(str(it))
        f.write('\n')
        
with open('frm_add_latency.txt', 'w') as f:
    for it in fadiffs:
        f.write(str(it))
        f.write('\n')
        
with open('adj_latency.txt', 'w') as f:
    for it in adjdiffs:
        f.write(str(it))
        f.write('\n')
        
with open('adj2_latency.txt', 'w') as f:
    for it in ddiffs:
        f.write(str(it))
        f.write('\n')
        
with open('full_latency.txt', 'w') as f:
    for it in fullloop:
        f.write(str(it))
        f.write('\n')
