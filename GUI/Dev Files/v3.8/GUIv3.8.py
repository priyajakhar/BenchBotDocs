...
class Page3(QWidget):
    ...
    #     global process_complete
    #     if process_complete:
    #         self.l2.setText('Total time taken: '+str(elapsed_hr)+ ' hrs '+str(elapsed_min+1)+ ' mins')
    #     else:
    #         self.l2.setText('  Time Elapsed: '+str(elapsed_hr)+ ' hrs '+str(elapsed_min+1)+ ' mins')
